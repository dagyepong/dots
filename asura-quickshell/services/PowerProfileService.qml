...
Singleton {
    ...
    onUseCustomProfileChanged: refreshStatus()
    onCustomPathChanged: refreshStatus()
    ...
    Connections {
        ...
        function onQuickSettingsOpenChanged() {
            if (GlobalStates.quickSettingsOpen) root.refreshStatus();
        }
        function onSettingsOpenChanged() {
            if (GlobalStates.settingsOpen) root.refreshStatus();
        }
    }
}
