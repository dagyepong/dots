...
// MODIFIED: NotificationServer block commented out to prevent D-Bus conflict with Brave
...
Singleton {
  ...
  /* 
   * DISABLED: NotificationServer
   * This block was causing a D-Bus conflict with Brave Browser.
   * QuickShell no longer registers as the notification server.
   * Use an external daemon (dunst, mako, swaync) instead.
   */
  /*
  NotificationServer {
    id: notifServer
  ...
  */
  ...
  function discardNotification(id) {
    ...
    // NOTE: Since NotificationServer is disabled, the server index logic below will fail.
    // We skip the server-side dismissal to prevent errors.
    ...
    // Removed: notifServer.trackedNotifications... logic
  ...
  function attemptInvokeAction(id, notifIdentifier) {
    ...
    // NOTE: Since NotificationServer is disabled, action invocation will not work via QuickShell.
    // Actions must be handled by the external notification daemon.
