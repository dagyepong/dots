...
const extConfig = {
  ...
  numberDisplayReformatLikes: true, // [true, false*] Re-format like numbers (Make likes and dislikes format consistent)
...
if (window.trustedTypes && window.trustedTypes.defaultPolicy) {
  htmlString = window.trustedTypes.defaultPolicy.createHTML(htmlString);
}
getButtons().insertAdjacentHTML('beforeend', htmlString);
...
function setState() {
  ...
  xhr.open('GET', `https://returnyoutubedislikeapi.com/votes?videoId=${videoId}`, true);
  xhr.onload = function() {
