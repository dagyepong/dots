...
> = 0.01; // Reduced from 0.4

uniform float Contrast < __UNIFORM_SLIDER_FLOAT1
	ui_min = 0.5; ui_max = 2.0;
> = 0.85; // Reduced from 0.83

uniform float Linearization < __UNIFORM_SLIDER_FLOAT1
	ui_min = 0.5; ui_max = 2.0;
> = 0.3; // Increased slightly from 0.5 to lessen intensity

uniform float Bleach < __UNIFORM_SLIDER_FLOAT1
	ui_min = -0.5; ui_max = 1.0;
	ui_tooltipltip = "More bleach means more contrasted and less colorful image";
> = -0.35; // Adjusted slightly to reduce bleach effect
