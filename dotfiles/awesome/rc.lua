...
local screenshot =
	"scrot -e 'mv $f ~/Pictures/Screenshots && xclip -selection clipboard -t image/png -i ~/Pictures/Screenshots/$n'; sleep 1; exec notify-send 'screenshot has been saved to ~/Pictures'"
local screenshot_block =
	"scrot -s -e 'mv $f ~/Pictures/Screenshots && xclip -selection clipboard -t image/png -i ~/Pictures/Screenshots/$n'; sleep 1; exec notify-send 'screenshot has been saved to ~/Pictures'"
local dmenu =
	[[j4-dmenu-desktop --term=alacritty --dmenu="dmenu -p ./ -i -fn 'Roboto Mono Nerd Font-11' -nb '#000000' -nf '#aaaaaa' -sb '#000000'  -sf '#ff8c00'" ]]
...
globalkeys = mytable.join(
	...
	-- Tag browsing
	awful.key({ modkey, "Shift" }, "z", awful.tag.viewprev, { description = "view previous", group = "tag" }),
	awful.key({ modkey, "Shift" }, "x", awful.tag.viewnext, { description = "view next", group = "tag" }),
	...
	awful.key({ modkey }, "F3", awesome.quit, { description = "logout", group = "awesome" }),
	awful.key({ modkey }, "F2", function()
		awesome.spawn("reboot")
	end, { description = "reboot system", group = "awesome" }),
	awful.key({ modkey }, "F1", function()
		awesome.spawn("shutdown now")
	end, { description = "shutdown system", group = "awesome" }),
	awful.key({ modkey }, "F4", function()
		awesome.spawn("systemctl hibernate")
	...
	awful.key({ modkey, "Shift" }, "s", function()
		awful.util.spawn.with_shell(screenshot)
	end, { description = "take screenshot", group = "launcher" }),

	awful.key({ modkey }, "s", function()
		awful.util.spawn.with_shell(screenshot_block)
	end, { description = "take screenshot block", group = "launcher" }),
	...
	end, { description = "kill picom compositor", group = "launcher" }),

	awful.key({ modkey, "Shift" }, "`", function()
		awful.spawn("picom --experimental-backends")
	end, { description = "run picom compositor", group = "launcher" }),
	...
	-- rofi
	awful.key({ modkey }, "d", function()
		os.execute(string.format("rofi -show %s -theme %s", "drun", "sidebar"))
	end, { description = "show rofi", group = "launcher" }),

	awful.key({ modkey, "Shift" }, "d", function()
		os.execute(string.format("passmenu"))
	end, { description = "show passmenu", group = "launcher" })
...
awful.rules.rules = {
	-- All clients will match this rule.
	{
		...
		properties = {
			...
			awful.placement.no_offscreen + awful.placement.restore,
	...
	{ rule = { instance = "brave" }, properties = { screen = 1, tag = "II" } },

	{ rule = { instance = "polybar-ein_default" }, properties = { titlebars_enabled = false } },

	{ rule = { instance = "dolphin" }, properties = { screen = 1, tag = "III" } },

	{ rule = { instance = "easyeffects" }, properties = { screen = 1, tag = "V" } },

	{ rule = { instance = "qbittorrent" }, properties = { screen = 1, tag = "IV" } },
