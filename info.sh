...
gitdir=https://github.com/dagyepong/
myblog=https://linuxpad.blog
...
birthd=`head -n 1 /var/log/emerge.log | awk '{print $1}' | tr - .`

echo "Package count: $pkgnum"
echo "System install date: $birthd"
