# HypeShell Translations

This directory contains translation files for HypeShell extracted from all qsTr() calls in the QML codebase.
...
```bash
cd /home/brandon/.config/quickshell/HypeShell/translations
