...
Item {
    id: root
    readonly property var log: Log.scoped("HypePopoutConnected")

    property var popoutHandle: root
    property string layerNamespace: "hype:popout"
    ...
    PanelWindow {
        ...
        WlrLayershell.layer: {
            switch (Quickshell.env("HYPE_POPOUT_LAYER")) {
            case "bottom":
            ...
            Item {
                ...
                Item {
                    ...
                    ElevationShadow {
                        ...
                        shadowEnabled: Theme.elevationEnabled && SettingsData.popoutElevationEnabled && Quickshell.env("HYPE_DISABLE_LAYER") !== "true" && Quickshell.env("HYPE_DISABLE_LAYER") !== "1" && !(root.suspendShadowWhileResizing && root._resizeActive) && !root.frameOwnsConnectedChrome
