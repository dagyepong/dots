...
Item {
    ...
    function setSearchQuery(query) {
        ...
        var filesInAll = searchMode === "all" && (SettingsData.hypeLauncherV2IncludeFilesInAll || SettingsData.hypeLauncherV2IncludeFoldersInAll);
    ...
    function setMode(mode, isAutoSwitch) {
        ...
        modeChanged(mode);
        performSearch();
        var filesInAll = mode === "all" && (SettingsData.hypeLauncherV2IncludeFilesInAll || SettingsData.hypeLauncherV2IncludeFoldersInAll) && searchQuery.length > 0;
    ...
    function performSearch() {
        ...
        if (searchMode === "apps") {
            ...
            if (isCategoryFiltered) {
                ...
                // Also include core apps (HYPE Settings etc.) that match this category
    ...
    function performFileSearch() {
        ...
        var includeFiles = SettingsData.hypeLauncherV2IncludeFilesInAll;
        var includeFolders = SettingsData.hypeLauncherV2IncludeFoldersInAll;
