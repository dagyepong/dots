# Spec for HYPE Greeter - Stable releases
...
chown -R greeter:greeter %{_localstatedir}/cache/hype-greeter 2>/dev/null || true
...
2. Sync your theme with the greeter (optional):
     If you have HypeMaterialShell (HYPE) installed, you can sync theming with:
     hype greeter sync
