...
// GetCurrentVersion provides a mock function with given fields: hypePath
func (_m *MockVersionFetcher) GetCurrentVersion(hypePath string) (string, error) {
	ret := _m.Called(hypePath)
...
//   - hypePath string
func (_e *MockVersionFetcher_Expecter) GetCurrentVersion(hypePath interface{}) *MockVersionFetcher_GetCurrentVersion_Call {
	return &MockVersionFetcher_GetCurrentVersion_Call{Call: _e.mock.On("GetCurrentVersion", hypePath)}
}

func (_c *MockVersionFetcher_GetCurrentVersion_Call) Run(run func(hypePath string)) *MockVersionFetcher_GetCurrentVersion_Call {
...
// GetLatestVersion provides a mock function with given fields: hypePath
func (_m *MockVersionFetcher) GetLatestVersion(hypePath string) (string, error) {
	ret := _m.Called(hypePath)
...
//   - hypePath string
func (_e *MockVersionFetcher_Expecter) GetLatestVersion(hypePath interface{}) *MockVersionFetcher_GetLatestVersion_Call {
	return &MockVersionFetcher_GetLatestVersion_Call{Call: _e.mock.On("GetLatestVersion", hypePath)}
}

func (_c *MockVersionFetcher_GetLatestVersion_Call) Run(run func(hypePath string)) *MockVersionFetcher_GetLatestVersion_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
