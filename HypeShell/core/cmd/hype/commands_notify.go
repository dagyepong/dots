...
Examples:
  hype notify "Hello" "World"
  hype notify "File received" "photo.jpg" --file ~/Downloads/photo.jpg --icon smartphone
  hype notify "Download complete" --file ~/Downloads/file.zip --app "My App"`,
