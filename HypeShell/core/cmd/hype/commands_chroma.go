...
Examples:
  hype chroma main.go
  hype chroma --language python script.py
  echo "def foo(): pass" | hype chroma -l python
  cat code.rs | hype chroma -l rust --style dracula
  hype chroma --markdown README.md
  hype chroma --markdown --style github-dark notes.md
  hype chroma list-languages
  hype chroma list-styles`,
