...
Examples:
  hype system update --check                  # list available updates
  hype system update                          # apply updates (interactive prompt)
  hype system update --noconfirm              # apply updates without prompting
  hype system update --dry                    # simulate without changing anything
  hype system update --no-flatpak --noconfirm # apply system updates only
  hype system update --interval 3600          # set the server poll interval to 1h`,
	Run: runSystemUpdate,
}
