...
Examples:
  hype screenshot                     # Region select, save file + clipboard
  hype screenshot full                # Full screen of focused output
  hype screenshot all                 # All screens combined
  hype screenshot output -o DP-1      # Specific output
  hype screenshot window              # Focused window (Hyprland)
  hype screenshot last                # Last region (pre-selected)
  hype screenshot --reset             # Reset last region pre-selection
  hype screenshot --no-clipboard      # Save file only
  hype screenshot --no-file           # Clipboard only
  hype screenshot --no-confirm        # Region capture on mouse release
  hype screenshot --cursor=on         # Include cursor
  hype screenshot -f jpg -q 85        # JPEG with quality 85`,
}
