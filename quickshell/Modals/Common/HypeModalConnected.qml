...
Item {
    id: root
    readonly property var log: Log.scoped("HypeModalConnected")

    property var modalHandle: root
    property string layerNamespace: "hype:modal"
    ...
    PanelWindow {
        ...
        Item {
            ...
            // Connected emergence: travel from the resolved bar edge, matching HypePopout cadence.
            ...
            Item {
                ...
                Item {
                    ...
                    ElevationShadow {
                        ...
                        shadowEnabled: !root.frameOwnsConnectedChrome && root.enableShadow && Theme.elevationEnabled && SettingsData.modalElevationEnabled && Quickshell.env("HYPE_DISABLE_LAYER") !== "true" && Quickshell.env("HYPE_DISABLE_LAYER") !== "1"
                    }
