...
Item {
    id: root
    readonly property var log: Log.scoped("HypeLauncherV2ModalConnected")
    ...
    readonly property bool unloadContentOnClose: SettingsData.hypeLauncherV2UnloadOnClose

    // Animation state — matches HypePopout/HypeModal pattern
    ...
    readonly property color borderColor: {
        if (!SettingsData.hypeLauncherV2BorderEnabled)
            return Theme.outlineMedium;
        switch (SettingsData.hypeLauncherV2BorderColor) {
        case "primary":
    ...
    readonly property int borderWidth: SettingsData.hypeLauncherV2BorderEnabled ? SettingsData.hypeLauncherV2BorderThickness : 0
    ...
    function _nextChromeClaimId() {
        return "hype:launcher-v2:" + (new Date()).getTime() + ":" + Math.floor(Math.random() * 1000);
    }
    ...
    PanelWindow {
        ...
        WlrLayershell.namespace: "hype:spotlight:bg"
    ...
    PanelWindow {
        ...
        WlrLayershell.namespace: "hype:spotlight"
        WlrLayershell.layer: {
            switch (Quickshell.env("HYPE_MODAL_LAYER")) {
            case "bottom":
            ...
            Item {
                ...
                Item {
                    ...
                    ElevationShadow {
                        ...
                        shadowEnabled: !root.frameOwnsConnectedChrome && Theme.elevationEnabled && SettingsData.modalElevationEnabled && Quickshell.env("HYPE_DISABLE_LAYER") !== "true" && Quickshell.env("HYPE_DISABLE_LAYER") !== "1"
                    }

                    // contentWrapper moves inside static contentContainer — HypePopout pattern
                    Item {
                        id: contentWrapper
                        width: parent.width
                        height: parent.height
