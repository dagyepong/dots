...
PanelWindow {
    id: root
    readonly property var log: Log.scoped("HypeOSD")

    property string blurNamespace: "hype:osd"
    ...
    WlrLayershell.layer: {
        switch (Quickshell.env("HYPE_OSD_LAYER")) {
        case "bottom":
    ...
    Item {
        ...
        ElevationShadow {
            ...
            borderWidth: 1
            shadowEnabled: Theme.elevationEnabled && SettingsData.popoutElevationEnabled && Quickshell.env("HYPE_DISABLE_LAYER") !== "true" && Quickshell.env("HYPE_DISABLE_LAYER") !== "1"
