...
Item {
    ...
    readonly property var log: Log.scoped("HypePopoutStandalone")
            ...
            Item {
                ...
                Item {
                    ...
                    ElevationShadow {
                        ...
                        shadowEnabled: Theme.elevationEnabled && SettingsData.popoutElevationEnabled && Quickshell.env("HYPE_DISABLE_LAYER") !== "true" && Quickshell.env("HYPE_DISABLE_LAYER") !== "1" && !(root.suspendShadowWhileResizing && root._resizeActive)
                    }
